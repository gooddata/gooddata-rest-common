...
public class ErrorStructureTest {
    ...
    @Test
    public void testDeserializationStructure() throws Exception {
        ...
        assertThat(errStructure.toString(), is("MSG PARAM1 PARAM2 3"));
    }

    @Test
    public void testDeserialization() throws Exception {
        final ErrorStructure errStructure = readObjectFromResource("/gdc/gdcError.json", ErrorStructure.class);

        assertThat(errStructure, is(notNullValue()));
        assertThat(errStructure.getErrorClass(), is("CLASS"));
        assertThat(errStructure.getTrace(), is("TRACE"));
        assertThat(errStructure.getMessage(), is("MSG %s %s"));
        assertThat(errStructure.getComponent(), is("COMPONENT"));
        assertThat(errStructure.getErrorId(), is("ID"));
        assertThat(errStructure.getErrorCode(), is("CODE"));
        assertThat(errStructure.getRequestId(), is("REQ"));
        ...
        assertThat(errStructure.getFormattedMessage(), is("MSG PARAM1 PARAM2"));
        assertThat(errStructure.toString(), is("MSG PARAM1 PARAM2"));
    }
}